...
"")
        ...
        self.lbl_voltar_menu = QLabel(self.widget_status)
        self.lbl_voltar_menu.setObjectName(u"lbl_voltar_menu")
        self.lbl_voltar_menu.setGeometry(QRect(100, 15, 171, 21))
        self.lbl_voltar_menu.setStyleSheet(u"background-color: #adc178; \n"
"font: 75 8pt \"MS Shell Dlg 2\";\n"
"font: 75 10pt \"MS Shell Dlg 2\";\n"
"border-radius: 5px;\n"
"")
...
"")
    ...
    def retranslateUi(self, Status):
        ...
        self.lbl_voltar_menu.setText(QCoreApplication.translate("Status", u"<html><head/><body><p align=\"center\">Status do Pedido</p></body></html>", None))
